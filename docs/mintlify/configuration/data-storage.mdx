...
description: "CostHQ stores all session data in a local SQLite file at ~/.CostHQ/sessions.db. No cloud sync, no telemetry. Learn to back up, export, and reset your data."
---
