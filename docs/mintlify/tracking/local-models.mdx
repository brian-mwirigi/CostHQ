...
description: "Track AI usage for self-hosted models where cost is compute-time based. Register models with a $/hr GPU rate, auto-detect Ollama, and log usage with --duration."
---
