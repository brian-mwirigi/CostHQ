...
import Insights from '../../pro/dashboard/Insights';
import Alerts from '../../pro/dashboard/Alerts';
import LicenseSettings from '../../pro/dashboard/LicenseSettings';
import Donate from './components/Donate';
import Feedback from './components/Feedback';
import ShareCard from '../../pro/dashboard/ShareCard';
...
export type Page = 'overview' | 'sessions' | 'models' | 'local-models' | 'pricing' | 'insights' | 'alerts' | 'upgrade' | 'donate' | 'feedback' | 'share' | 'console' | 'pro' | 'audit';
